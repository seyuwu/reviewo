...
export function HomeQuickNav() {
  ...
  const links: QuickNavItem[] = [
    {
      analytics: "home_quick_games",
      description: t("web.homeFeed.quickGames"),
      external: true,
      href: getGamesHomeUrl(),
      icon: "gamepad",
      iconClass: "home-quick-nav-icon--games",
      label: t("web.vertical.games")
    },
    {
      analytics: "home_quick_dota",
      description: t("web.homeFeed.quickDota"),
      external: true,
      href: getDotaHomeUrl(),
      icon: "gamepad",
      iconClass: "home-quick-nav-icon--games",
      label: t("web.nav.dotaVertical")
    },
    {
      description: t("web.homeFeed.quickBattles"),
      external: false,
      href: "/battles",
      icon: "battle",
      iconClass: "home-quick-nav-icon--battles",
      label: t("web.nav.battles")
    },
    {
      description: t("web.homeFeed.quickTops"),
      external: false,
      href: "/top",
      icon: "trophy",
      iconClass: "home-quick-nav-icon--tops",
      label: t("web.nav.tops")
    },
    {
      description: t("web.homeFeed.quickSpotlight"),
      external: false,
      href: "/spotlight",
      icon: "spotlight",
      iconClass: "home-quick-nav-icon--spotlight",
      label: t("web.nav.spotlight")
    },
    {
      description: t("web.homeFeed.quickContribute"),
      external: false,
      href: "/contribute",
      icon: "help",
      iconClass: "home-quick-nav-icon--contribute",
      label: t("web.nav.contribute")
    },
    {
    ...
    <nav className="home-quick-nav" aria-label={t("web.homeFeed.quickNavAriaLabel")}>
      {links.map((link) =>
        link.external ? (
          ...
          <Link key={`${link.label}-${link.href}`} className="home-quick-nav-card" href={link.href}>
            <span className={`home-quick-nav-icon ${link.iconClass}`} aria-hidden="true">
              <OpiniaIcon name={link.icon} />
            </span>
            <span className="home-quick-nav-copy">
